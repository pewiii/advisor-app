<template>
    <!-- Footer start -->
    <div class="bg-slate-900 w-full flex justify-center items-center md:justify-evenly flex-col md:flex-row gap-8 p-8">
        <!-- Overview start -->
        <div class="text-stone-100 text-center">
            <p class="tracking-widest font-semibold text-stone-100">PACKTHEMIN</p>
        </div>
        <!-- Overview end -->
