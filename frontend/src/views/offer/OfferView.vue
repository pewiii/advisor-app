<template>
  ...
  <div v-else class="w-full h-full flex justify-center items-center min-h-screen p-10" :style="{'background-image': `url(${image})`, 'background-size': 'cover', 'background-position': 'center', 'background-attachment': 'fixed' }">
